...
int write_to_mav (uint8_t * b, int sz){
    ...
    mavlink_ardupilotmega::MAV_RAW_DATA m;
    
    m.channel=mavlink_ardupilotmega::MAV_RAW_DATA::CH_COMM0;
 ...
 *
 */            
void from_mav_mav_raw_data_callback(const mavlink_ardupilotmega::MAV_RAW_DATA::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_mav_raw_data_callback request");
